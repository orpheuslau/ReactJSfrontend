...
*/
  ...
  const updateStudent = async () => {
    ...
    if (!data.name || !data.classid) {
      ...
      try {
        id = data._id;
        await axios.put(`https://seemly-cattle-production.up.railway.app/api/students/${id}`, data);
  ...
  const addStudent = async () => {
    if (!data.name || !data.classid) {
      ...
      setToggleCleared(!toggleCleared);
      try {
        await axios.post(`https://seemly-cattle-production.up.railway.app/api/students`, data);
  ...
  const deleteStudent = async () => {
    ...
    if (window.confirm(`Are you sure you want to delete the profile of : "${data.name}"?`)) {
      try {
        id = data._id;
        await axios.delete(`https://seemly-cattle-production.up.railway.app/api/students/${id}`, data);
